...
export const renderWinnersTable = (): HTMLElement => {
  ...
  const topTableRow: HTMLElement = createElem('div', 'winners-table__top-row');
  const numberTop: HTMLElement = createElem('p', 'winners-table__column-name');
  numberTop.innerHTML = 'Number';
  const carTop: HTMLElement = createElem('p', 'winners-table__column-name');
  carTop.innerHTML = 'Car';
  const nameTop: HTMLElement = createElem('p', 'winners-table__column-name');
  nameTop.innerHTML = 'Name';
  const winsTop: HTMLElement = createElem('p', 'winners-table__column-name');
  winsTop.innerHTML = 'Wins';
  const bestTimeTop: HTMLElement = createElem('p', 'winners-table__column-name');
  bestTimeTop.innerHTML = 'Best time (sec)';
  topTableRow.append(numberTop, carTop, nameTop, winsTop, bestTimeTop);
